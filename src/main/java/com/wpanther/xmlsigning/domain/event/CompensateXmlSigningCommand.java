 ...
 */
@Getter
public class CompensateXmlSigningCommand extends IntegrationEvent {
     ...
     */
    public CompensateXmlSigningCommand(String sagaId, String sagaStep, String correlationId,
