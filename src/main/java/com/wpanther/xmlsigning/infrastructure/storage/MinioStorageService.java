...
public class MinioStorageService {
     ...
     */
    public String uploadOriginalXml(String documentId, String documentType, String xmlContent) {
        ...
        try {
            ...
            String sanitizedInvoiceId = documentId.replaceAll("[^a-zA-Z0-9\\-_]", "_");
            ...
            log.error("Failed to upload original XML to MinIO: documentId={}, documentType={}",
                    documentId, documentType, e);
            throw new DocumentStorageException(
     ...
     * @throws DocumentStorageException if upload fails
     */
    public StorageResult upload(String documentId, String documentType, String xmlContent) {
        String s3Key = "unknown";
        try {
            byte[] xmlBytes = xmlContent.getBytes(StandardCharsets.UTF_8);
            if (xmlBytes.length > maxUploadSizeBytes) {
            ...
            log.error("Failed to upload signed XML to MinIO: documentId={}, documentType={}",
                    documentId, documentType, e);
            throw new DocumentStorageException(
